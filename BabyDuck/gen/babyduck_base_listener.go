...
func (s *BaseBabyDuckListener) EnterVar_list(ctx *Var_listContext) {}

// ExitVar_list is called when production var_list is exited.
func (s *BaseBabyDuckListener) ExitVar_list(ctx *Var_listContext) {}
...
func (s *BaseBabyDuckListener) EnterId_list(ctx *Id_listContext) {}

// ExitId_list is called when production id_list is exited.
func (s *BaseBabyDuckListener) ExitId_list(ctx *Id_listContext) {}
...
func (s *BaseBabyDuckListener) EnterFunctype(ctx *FunctypeContext) {}

// ExitFunctype is called when production functype is exited.
func (s *BaseBabyDuckListener) ExitFunctype(ctx *FunctypeContext) {}
